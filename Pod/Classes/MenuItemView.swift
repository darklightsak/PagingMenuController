...
open class MenuItemView: UIView {
    ...
    fileprivate var labelSize: CGSize {
        ...
        // CGFloat.max => CGFloat.greatestFiniteMagnitude
        return NSString(string: text).boundingRect(with: CGSize(width: CGFloat.greatestFiniteMagnitude, height: CGFloat.greatestFiniteMagnitude), options: .usesLineFragmentOrigin, attributes: [NSAttributedString.Key.font : titleLabel.font as Any], context: nil).size
    }
