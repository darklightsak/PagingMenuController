...
open class MenuView: UIScrollView {
    ...
    fileprivate func setupScrollView() {
        ...
        decelerationRate = UIScrollView.DecelerationRate(rawValue: options.deceleratingRate)
        scrollsToTop = false
    ...
    fileprivate func focusMenuItem() {
        let selected: (MenuItemView) -> Bool = { self.menuItemViews.firstIndex(of: $0) == self.currentPage }
